...
attempt of the batch. Model self-typo'd `get_hyduction_daily` in the PR
body summary (actual code is correct) — cosmetic defect not caught by
any harness mechanism.
