...
| [0006](0006-qwen3-6-default-runner-model.md) | `qwen3.6:latest` is the default `RUNNER_MODEL` | Verbose-but-correct beats fast-but-fragile for a default. 3/3 PASS in the bake-off. | Accepted | 2026-06-21 |
